function printCellArray4(varargin)
%function printCellArray(headers,data,filename)
%
%data is a cell array of numbers, the legth can be different; no matrices.
%headers: these are the column heads for the data
%file name is the file name (include path or it will be placed in pwd).
...
if nargin==3 %there is some data also;
    data = varargin{2};
